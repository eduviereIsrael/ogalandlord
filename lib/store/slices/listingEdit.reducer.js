...
import { saveImageToStorage, deleteImageFromStorage, fetchListingsByEmail, updateListings } from "@/lib/firebase/firebase.utils";
...
export const { updateDetails, setEditListing, updateLocation, addAmenity, clearPrimaryImage, updateChosenAmeninites, setUploadMsg, updatePrimaryImage } = listingUploadSlice.actions
