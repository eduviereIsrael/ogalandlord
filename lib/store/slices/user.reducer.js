...
import { createAuthUserWithEmailAndPassword, signInWithGooglePopup, signInWithGoogleRedirect, updateUserSubscription, updateUserProduct, createUserDocumentFromAuth, getCurrentUser, signInAuthUserWithEmailAndPassword, signOutUser, fetchUserByEmail, sendPasswordReset } from "@/lib/firebase/firebase.utils";
...
export const {setUserError, signInSuccess, setSignupModal, setSigninModal, closeAuth, setPasswordRecoveryModal, setpasswordRecoverySuccess  } = userSlice.actions;
