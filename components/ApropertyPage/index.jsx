  ...
  return (
    <div className="s-property-page">
      <div className="header">
        <a href="/admin/listings" className="back">
        ...
        <div className="heading">
          ...
          <div className="buttons">
            <button style={{ padding: "17px 55px" ,backgroundColor: "#18BB48"}} onClick={null} >
              
               Verify
            </button>
            <button style={{ padding: "17px 55px" ,backgroundColor: "#FF0303"}} onClick={null} >
